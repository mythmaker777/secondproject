...
8. Tap *Customize information* → tick *Followers and following* only
9. Tap *Format* → select *JSON* (not HTML!)
10. Tap *Start export* — Instagram will email you a download link

Download the ZIP from that email and send it here.

⏱ Instagram usually sends the email within 10–30 minutes — come back when it arrives!

You can also send the two JSON files individually: followers\_1.json and following.json"""
